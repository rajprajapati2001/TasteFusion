    ...
    <div id="main-wrapper">
         ...
         <div class="header">
            ...
            <a class="navbar-brand" href="dashboard.php">
                        <span><img src="../images/admin_logo.png" style="width: 40px; height: 40px;" alt="homepage" class="dark-logo" /></span>&nbsp;
                        <span style="font-size: 30px; font-family: system-ui;">All Order List</span>
                    </a>
                </div>

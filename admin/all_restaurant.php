...
<head>
    ...
    <link rel="icon" href="images/admin-icon-128x128.png">
    ...
    <div id="main-wrapper">
         ...
         <div class="header">
            ...
            <div class="navbar-header">
                    ...
                    <span><img src="../images/admin_logo.png" style="width: 40px; height: 40px; margin-left: 20px;" alt="homepage" class="dark-logo" /></span>&nbsp;
                        <span style="font-size: 30px; font-family: system-ui;">List of All Restaurants</span>
                    </a>
                </div>
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../images/admin_logout.png" alt="user" style="width: 40px; height: 40px;" /></a>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                ...
                                <div class="table-responsive m-t-40" style="scrollbar-width: thin;">

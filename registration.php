...
<body>
<div style="background-size: cover; background-image: url('images/imgi_3_food-4k-anl1yr892h6ccjeb.jpg');">
         ...
         <div class="page-wrapper">
            ...
            <section class="contact-page inner-page" style="margin-bottom: 0px;">
               <div class="container ">
                  <div class="module form-module">
                     <div class="col-md-12">
                        <div class="widget" style="border-top: 5px solid #5c4ac7;">
                           <div class="widget-body">
                          
							  <form action="" method="post"  >
                                 <h2 style="margin: 0 0 20px; color: #5c4ac7;font-size: 18px;font-weight: 400;line-height: 1;">Create your Account</h2>
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
									 ...
									 <div class="form-group col-sm-12">
                                       ...
                                       <textarea class="form-control" id="exampleTextarea"  name="address" rows="2"></textarea>
                                    </div>
